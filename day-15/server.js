...
// Day 9: Catalog
app.use('/ucp/v1/catalog', catalogRouter)

// Day 10: Identity linking
app.use('/ucp/v1/identity', identityRouter)
app.use('/auth/link', (req, res) => {
  res.redirect(`/ucp/v1/identity/auth-page?session=${req.query.session}`)
})

// Day 11: Webhooks + order tracking
app.use('/ucp/v1/webhooks', webhooksRouter)
app.use('/ucp/v1', webhooksRouter)   // for /orders/:id routes
